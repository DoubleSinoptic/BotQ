 ...
 *  @param[in] mWidth The new mWidth, in screen coordinates, of the window.
 *  @param[in] mHeight The new mHeight, in screen coordinates, of the window.
 *
 *  @sa @ref window_size
 ...
 *  @param[in] mWidth The new mWidth, in pixels, of the framebuffer.
 *  @param[in] mHeight The new mHeight, in pixels, of the framebuffer.
 *
 ...
 *
 *  @param[in] mWidth The desired mWidth, in screen coordinates, of the window.
 *  This must be greater than zero.
 *  @param[in] mHeight The desired mHeight, in screen coordinates, of the window.
 *  This must be greater than zero.
 ...
 *  @param[out] mWidth Where to store the mWidth, in screen coordinates, of the
 *  client area, or `NULL`.
 *  @param[out] mHeight Where to store the mHeight, in screen coordinates, of the
 *  client area, or `NULL`.
 *
 *  @errors Possible errors include @ref GLFW_NOT_INITIALIZED and @ref
 *  GLFW_PLATFORM_ERROR.
 ...
 *  @param[in] minwidth The minimum mWidth, in screen coordinates, of the client
 *  area, or `GLFW_DONT_CARE`.
 *  @param[in] minheight The minimum mHeight, in screen coordinates, of the
 *  client area, or `GLFW_DONT_CARE`.
 *  @param[in] maxwidth The maximum mWidth, in screen coordinates, of the client
 *  area, or `GLFW_DONT_CARE`.
 ...
 *  @param[out] mWidth Where to store the mWidth, in pixels, of the framebuffer,
 *  or `NULL`.
 *  @param[out] mHeight Where to store the mHeight, in pixels, of the framebuffer,
 *  or `NULL`.
 *
 *  @errors Possible errors include @ref GLFW_NOT_INITIALIZED and @ref
 *  GLFW_PLATFORM_ERROR.
 ...
 *  initially created.  SetTransform the [GLFW_FOCUSED](@ref window_hints_wnd) to disable
 *  this behavior.
 *
 ...
 *  client area.
 *  @param[in] mWidth The desired with, in screen coordinates, of the client area
 *  or video mode.
 *  @param[in] mHeight The desired mHeight, in screen coordinates, of the client
 *  area or video mode.
...
/*! @brief Returns the current reported state of a keyboard key for the specified
 *  window.
 *
 *  This function returns the current state reported for the specified key to the
...
/*! @brief Returns the current reported state of a mouse button for the specified
 *  window.
 *
 *  This function returns the current state reported for the specified mouse button
